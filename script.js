...
function createNote(){
    ...
    node1.setAttribute("style", "width:250px; height:250px; font-size:2rem; padding:25px; margin-top:10px; overflow:hidden; box-shadow: 0px 10px 24px 0px rgba(0,0,0,0.75)");

    node1.style.margin = margin();
    node1.style.transform = roate();
    ...
    node0.addEventListener("mouseenter",function(){
        node0.style.tansform = "scale(1.1)";
    })
    ...
    node0.addEventListener("doubleclick", function(){
        node0.remove();
    })

    docoument.getElementById("node-text").value = "";
}
